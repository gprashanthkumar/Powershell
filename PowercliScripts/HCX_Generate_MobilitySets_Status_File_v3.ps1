...
$vmsarray = @()
$Location  = "US"
$removeArray =@("WAVE8W_DE_MIG_RAV_1002_11-")
#$array += [PSCustomObject]@{Location = $Location ;MobilityGroup = "WAVE8W_DE_MIG_RAV_1002_11" ; Completed = "17"; Total = "18"; MigState = 'Replicated'; MigrationPeriod = "6/14/2025 4:30:00 AM - 6/17/2025 4:08:00 PM"} 
