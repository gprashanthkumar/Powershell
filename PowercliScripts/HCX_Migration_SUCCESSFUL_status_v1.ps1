...
$MigratingServers = Get-HCXMigration  -MigrationType RAV    -State MIGRATED  #| Where-Object { {$_.StartTime.Date -ge $filterDate} -and {$_.StartTime.Date -ge $filterDate} }
...
$MigratingServers = Get-HCXMigration   -State MIGRATED  #| Where-Object {$_.StartTime.Date -ge $filterDate}
...
$MigratingServers = Get-HCXMigration  -MigrationType Bulk    -State MIGRATED  # | Where-Object { {$_.StartTime.Date -ge $filterDate} -and {$_.StartTime.Date -ge $filterDate} }
 foreach($migration in $MigratingServers) {
